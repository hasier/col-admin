    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                                             related_name='family_members', to='membership.Family')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participant',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='health_info',
                                   to='membership.Participant')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participant',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='emergency_contacts',
                                   to='membership.Participant')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participant',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='contact_info',
                                   to='membership.Participant')),
            ],
            options={
                'abstract': False,
